...
\caption{Learning path: a five-minute self-check routes to the on-demand resources if it fails, or to the main sequence (video, strategy diagram, slides, experiments 1--3 and the report template) if it passes, ending at the acceptance checks.}
\label{fig:learning}
\end{figure}
